...
/// <summary>Allows the services provided by <i>Attribinter.Parameters.Type</i> to be registered with <see cref="IServiceCollection"/>.</summary>
public static class AttribinterTypeParametersServices
{
    /// <summary>Registers the services provided by <i>Attribinter.Parameters.Type</i> with the provided <see cref="IServiceCollection"/>.</summary>
